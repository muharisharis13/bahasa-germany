...
const Latihan1 = () => {
  ...
  const PercakapanA = () => {
    return (
      <div className=" mb-4">
        <div
          className={`flex items-center mb-2 space-x-2 ${answerIsCorrect(selectedJawaban.lima.a, jawabanBenar.lima.a)
            ? " text-green-500"
  ...
  const PercakapanB = () => {
    return (
      <div className=" mb-4">
        <div
          className={`flex items-center mb-2 space-x-2 ${answerIsCorrect(selectedJawaban.lima.b, jawabanBenar.lima.b)
            ? " text-green-500"
  ...
  const PercakapanC = () => {
    return (
      <div className=" mb-4">
        <div
          className={`flex items-center mb-2 space-x-2 ${answerIsCorrect(selectedJawaban.lima.c, jawabanBenar.lima.c)
            ? " text-green-500"
  ...
  const PercakapanD = () => {
    return (
      <div className=" mb-4">
        <div
          className={`flex items-center mb-2 space-x-2 ${answerIsCorrect(selectedJawaban.lima.d, jawabanBenar.lima.d)
            ? " text-green-500"
